                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">{{ $staff_id['name'] }}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Gender</div>
                                <div class="col-lg-9 col-md-8">{{ $staff_id['gender'] }}</div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">{{ $staff_id['alamat'] }}</div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">{{ $staff_id['email'] }}</div>
                            </div>
