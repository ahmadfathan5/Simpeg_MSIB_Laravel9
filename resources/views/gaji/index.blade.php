...
<div class="col-12">
    <div class="card recent-sales overflow-auto">
        <div class="card-body">
            ...
            @endif
            <br />
            <a class="btn btn-primary" title="Tambah Gaji Pegawai" href=" {{ route('pegawai.create') }}">
            ...
            <table class="table table-borderless datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rp{{number_format( $row->gapok, 2,',','.') }}</td>
                        <td>Rp{{number_format( $row->tunjab, 2,',','.') }}</td>
                        <td width="15%">
                            <form method="POST" id="formDelete">
                                ...
                                &nbsp;
                                <button type="submit" 
                                data-action="{{ route('gaji.destroy',$row->id) }}"
